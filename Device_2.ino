...
void publishstate() {
  if (led1State == 0) {
    client.publish("State1_2", "0") ;
  }
  else client.publish("State1_2", "1");

  if (led2State == 0) {
    client.publish("State2_2", "0");
  }
  else client.publish("State2_2", "1");
}
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect("ESP8266Client")) {
      ...
      client.subscribe("LED1_2");
      client.subscribe("LED2_2");
